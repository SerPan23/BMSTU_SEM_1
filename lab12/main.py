...
text = [
    ...
    'в висках стучит кровь, и руки кажутся руками поразительного дирижера, управляющего сразу ',
    'всеми симфониями возжигания 4 * 5 и испепеления, чтобы низвергнуть историю и оставить от нее обуглившиеся руины. Шлем '
...
# print()
# text = del_longer_sentence_start_letter(text)
# print_text(text)
# print()
