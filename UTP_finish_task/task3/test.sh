...
echo Тестирование скрипта вариант 3
...
bash ./comparator3.sh "./tests/file1.txt" "./tests/file1.txt" -v
echo Код возврата: "$?"
echo "$separator"
echo
...
bash ./comparator3.sh "./tests/file1.txt" "./tests/file2.txt" -v
echo Код возврата: "$?"
echo "$separator"
echo
...
bash ./comparator3.sh "./tests/notexist.txt" "./tests/file2.txt" -v
echo Код возврата: "$?"
echo "$separator"
echo
...
bash ./comparator3.sh "./tests/file1.txt" "./tests/file3.txt" -v
echo Код возврата: "$?"
echo "$separator"
echo
